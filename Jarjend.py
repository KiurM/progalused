...
def get_middle_part_of_list(elements: list) -> list:
    ...
    """
    list = elements[1:len(elements) - 1]
    return list
...
def swap_edge_elements(elements: list) -> list:
    ...
    pikkus = len(elements)
    idk = elements[0]
    elements[0] = elements[pikkus - 1]
    elements[pikkus - 1] = idk
    return elements
...
add_element_in_position([1], 9, 0)
add_element_in_position([1], 9, 1)
